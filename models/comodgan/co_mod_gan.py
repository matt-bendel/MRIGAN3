...
from models.comodgan.stylegan2 import PixelNorm, EqualLinear, EqualConv2d,ConvLayer,StyledConv,ToRGB,ConvToRGB,TransConvLayer
import numpy as np
...
class G_synthesis_co_mod_gan(nn.Module):
    def __init__(
        ...
        # Main layers.
        c_in = num_channels
        self.E = self.make_encoder(channel_in=16)
